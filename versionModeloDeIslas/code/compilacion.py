...
def compilarIndividuos(
    directorio, Isla, poblacion, programa, dependencias, flagsDependencias, debug
):
    global errores, salida
    directorioIslasGeneracion = directorio + "/Isla" + str(Isla) + "/"
    os.system("mkdir " + directorioIslasGeneracion)
    Cromosoma = 0
    for individuo in poblacion:
        directorioCromosoma = (
            directorioIslasGeneracion + "Cromosoma" + str(Cromosoma) + "/"
        )
        ...
        Cromosoma += 1
    return directorioIslasGeneracion
